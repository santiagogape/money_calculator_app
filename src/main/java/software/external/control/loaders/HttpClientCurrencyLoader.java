...
public class HttpClientCurrencyLoader implements CurrencyLoader {

    private final API api;
    private final CurrenciesDeserializer deserializer;

    public HttpClientCurrencyLoader(API api, CurrenciesDeserializer deserializer) {
        this.api = api;
    ...
    public List<Currency> load(String token) throws IOException {
        try (CloseableHttpClient client = HttpClients.createDefault()) {
            ...
            return deserializer.deserializer(responseBody);
