...
public class GsonJsonExchangeRatesDeserializer implements ExchangeRatesDeserializer {

    private final CurrencyReference reference;

    public GsonJsonExchangeRatesDeserializer(CurrencyReference reference) {
