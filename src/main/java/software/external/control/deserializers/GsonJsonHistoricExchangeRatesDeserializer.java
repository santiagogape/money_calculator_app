...
public class GsonJsonHistoricExchangeRatesDeserializer implements ExchangeRatesDeserializer {

    private final CurrencyReference reference;

    public GsonJsonHistoricExchangeRatesDeserializer(CurrencyReference reference) {
